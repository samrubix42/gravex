                ...
                <form wire:submit.prevent="save">
                    <div class="space-y-4">
                        <div class="grid grid-cols-1 gap-4">
                            ...
                            <div>
                                ...
                                <input
                                    wire:model="slug"
                                    placeholder="e.g. technology"
                                    class="w-full rounded-md border border-slate-300 bg-slate-50 px-3 py-2 text-sm text-slate-800
                                            focus:border-blue-500 focus:ring-2 focus:ring-blue-500/40 outline-none">
                                @error('slug') <span class="text-red-500 text-[10px] mt-1 block">{{ $message }}</span> @enderror
                            </div>
                        </div>
                        ...
                        <label class="inline-flex items-center gap-2 text-sm text-slate-700 cursor-pointer">
                            ...
                            <span>Active and visible in blog sections</span>
                        </label>
                    </div>
