...
<div class="max-w-7xl mx-auto px-4 sm:px-6 lg:px-8 py-4">
    ...
    <div class="mb-4 flex items-center justify-between">
        <div>
            <h1 class="text-lg font-semibold text-slate-900">Update Post</h1>
            <p class="text-[11px] text-slate-500 mt-0.5">Make changes to your published article.</p>
        </div>
        ...
        <div class="grid grid-cols-1 lg:grid-cols-3 gap-5">
            ...
            <div class="lg:col-span-2 space-y-5">
                ...
                <div class="bg-white rounded-xl border border-slate-200 p-5 shadow-sm">
                    ...
                    <div class="space-y-3">
                        <div>
                            <label class="block text-[10px] font-bold text-slate-600 uppercase tracking-widest mb-1">Meta Title</label>
