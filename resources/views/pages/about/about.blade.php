...
<div>
    ...
    <section class="relative pt-24 sm:pt-28 md:pt-32 pb-20 sm:pb-24 bg-blue-50/20 overflow-hidden">
        ...
        <div class="relative max-w-7xl mx-auto px-4 sm:px-6 grid md:grid-cols-2 gap-10 lg:gap-12 items-center">
            ...
            <!-- Focus Card -->
            <div class="bg-white border border-border rounded-xl p-6 sm:p-8 shadow-sm">
    ...
    <section class="py-16 sm:py-20 bg-muted">
        ...
        <div class="max-w-6xl mx-auto px-4 sm:px-6 grid grid-cols-1 sm:grid-cols-3 gap-6 sm:gap-8 text-center">
    ...
    <section class="py-20 sm:py-24 bg-white">
        ...
        <div class="max-w-7xl mx-auto px-4 sm:px-6">
            ...
            <div class="grid gap-5 sm:gap-6 mt-10 sm:mt-14 sm:grid-cols-2 lg:grid-cols-3">
    ...
    <section class="py-20 sm:py-24 bg-secondary text-white">
        ...
        <div class="max-w-4xl mx-auto px-4 sm:px-6 text-center">
            ...
            <a href="https://wa.me/918376059410?text=Hi%20happy%20to%20know%20about%20your%20services" target="_blank" class="mt-8 inline-flex items-center justify-center w-full sm:w-auto px-8 py-3 bg-white text-secondary font-semibold rounded-md hover:bg-gray-100 transition">
